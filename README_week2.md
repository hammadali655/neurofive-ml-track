...
- `Week2_Classification_model.ipynb` — data preparation, model training, and evaluation
- `README.md` — this document

### Next Steps

For future iterations, I plan to experiment with additional features — such as extracting titles from passenger names and calculating family size — and to compare Logistic Regression against other classifiers like Random Forest or Gradient Boosting to see whether recall on the "Survived" class can be improved without sacrificing overall accuracy.
